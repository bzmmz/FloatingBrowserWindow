...
StringInputDialog::StringInputDialog(PageBrowser* parent)
{
    ...
    connect(this, &StringInputDialog::ModifyTitleSignal, parent, &PageBrowser::SetWindowTitle);
    connect(this, &StringInputDialog::ModifyTitleSignal, this, &QWidget::close);

    //绑定收到主窗口关闭信号的反应
    connect(parent, &PageBrowser::MainWindowCloseSignal,this, &StringInputDialog::ReceiveMainWindowCloseSignal);
